...
const FR: &[(&str, &str)] = &[
    ...
    ("↑↓ scroll · every other key is forwarded to paru",
     "↑↓ défiler · les autres touches vont à paru"),
    ("Finished", "Terminé"),
    ("↑↓ PgUp PgDn scroll · Enter to return",
     "↑↓ PgUp PgDn défiler · Entrée revenir"),
    ("↑↓ PgUp PgDn scroll · Enter back to the table",
     "↑↓ PgUp PgDn défiler · Entrée revenir au tableau"),
